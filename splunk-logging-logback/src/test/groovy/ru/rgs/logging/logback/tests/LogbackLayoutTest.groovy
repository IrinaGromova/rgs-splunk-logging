...
package ru.rgs.logging.logback.tests
...
import ru.rgs.logging.logback.LogbackLoggingUtils
 ...
 */
class LogbackLayoutTest extends Specification {

    private final Logger log = LoggerFactory.getLogger(LogbackLayoutTest)
    private static final LogbackLoggingUtils loggingUtils = new LogbackLoggingUtils("self")
    ...
    @Unroll
    def "Test Logback layout with #keyToCheck field <-- #fileNameWithDataToCheck"(String fileNameWithDataToCheck, String fileNameWithExpectedData, String keyToCheck) {
        setup:
        prepareMdc()

        def data_to_check = Resources.readFromClassPath(LogbackLayoutTest.class, fileNameWithDataToCheck, null)
        def expected_result = Resources.readFromClassPath(LogbackLayoutTest.class, fileNameWithExpectedData, null)
